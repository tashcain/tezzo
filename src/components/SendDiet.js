...
export default class SendDiet extends Component {
    ...
    fetchAllMembers = () => {
        ...
        axios.post(ApiRoutes.api_route + '/gprofile/fetch-diet-loop', {
            gymId: lc
        })
            .then(res => {
                this.setState({
    ...
    SendDiet = () => {
        ...
        axios.post(ApiRoutes.api_route + '/diet/send-diet', {
            ...
            <div>
                <div className="uk-card uk-card-default uk-card-body">
                    ...
                    <div>
                        ...
                        <div className="mt-4">
                            <h3 className="set-heading" style={{ fontSize: '16px' }}>Select Diet </h3>
                            ...
                            >
                                {
                                    this.state.dietArr.map((data, index) => (
                                        <Option value={data.diet_id} key={index} >{`${data.diet_name}`}</Option>
                                    ))
                                }
                            </Select>

                        </div>
                        <Button className="gen-btn mt-4" loading={this.state.loading} onClick={this.SendDiet}>Send Diet</Button>
